...
import { FaCog, FaDesktop, FaHeadset, FaLaptop, FaLayerGroup, FaMobileAlt } from 'react-icons/fa'
    ...
    return (
        <div className='bg-pink-50 pt-20 pb-20'>
            <div className='w-[80%] mx-auto text-center'>
                <h1 className='mt-6 text-2xl md:text-3xl capitalize font-bold text-center'>It's Everything you will ever need</h1>
                <div className='grid mt-16 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                    {
                        features.map((feature, index) => (
                            <div key={index} className='flex items-center justify-center p-4 bg-white rounded-lg shadow-md space-x-3'>
                                <div className='text-3xl w-14 h-14 bg-gray-800  bg-opacity-80 flex items-center justify-center flex-col rounded-full'>
